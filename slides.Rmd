---
title: Generating accessible materials using Rmarkdown & Make
author: Clement Lee
date: 2021-03-17 (Wed)
output:
...
`\title{Generating accessible materials using R Markdown & Make}`  
`\author{Clement Lee}`  
`\date{2021-03-17 (Wed)}`  
`    `  
`\begin{document}`  
...
## Resources
* GitHub repository: https://github.com/clement-lee/talmo.git
